...
A - 世界のFizzBuzzEditorial
Time Limit : 2 sec / Memory Limit : 256 MB
問題文 :                     数字 N が与えられます。            N に 3
が含まれる、もしくは 3 で割り切れる場合はYES、それ以外は NO と出力してください。
...
入力は以下の形式で標準入力から与えられる。N        整数 N(1≦N≦9) が 1
行で与えられる。    出力                    N に 3 が含まれる、もしくは 3
で割り切れる場合はYES、それ以外は NO と出力してください。
また、出力の末尾には改行を入れること。
