...
配点 : 400 点
問題文 : 東西方向に伸びる道路に沿って A 社の神社と B
軒の寺が建っています。西から i 社目の神社は道路の西端から s_i
メートルの地点に、西から i 軒目の寺は道路の西端から t_i
メートルの地点にあります。以下の Q 個の問いに答えてください。問 i (1 \leq i \leq
Q): 道路の西端から x_i
メートルの地点から出発して道路上を自由に移動するとき、神社一社と寺一軒を訪れるのに必要な最小の移動距離は何メートルか？
(必要数を超えた数の寺社を通過してもよい。)
制約1 \leq A, B \leq 10^51 \leq Q \leq 10^51 \leq s_1 < s_2 < ... < s_A \leq
10^{10}1 \leq t_1 < t_2 < ... < t_B \leq 10^{10}1 \leq x_i \leq 10^{10}s_1, ...,
s_A, t_1, ..., t_B, x_1, ..., x_Q
はすべて異なる。入力される値はすべて整数である。入力入力は以下の形式で標準入力から与えられる。A
B Qs_1:s_At_1:t_Bx_1:x_Q出力Q 行出力せよ。i 行目に問 i への答えを出力すること。
