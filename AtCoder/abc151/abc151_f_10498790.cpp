...
F - Enclose AllEditorial
Time Limit : 2 sec / Memory Limit : 1024 MB
配点 : 600 点
問題文 : 平面上の N 個の点 (x_i, y_i)
が与えられます。これら全てを内部または周上に含む円の半径の最小値を求めてください。
制約2 ≤ N ≤ 500 ≤ x_i ≤ 10000 ≤ y_i ≤ 1000与えられる N
点は全て異なる入力で与えられる値は全て整数入力入力は以下の形式で標準入力から与えられる。Nx_1
y_1:x_N y_N出力N
個全ての点を内部または周上に含む円の半径の最小値を出力せよ。なお、想定解答との絶対誤差または相対誤差が
10^{-6} 以下であれば正解として扱われる。
// ソースコードの引用元 :
https://atcoder.jp/contests/abc151/submissions/10498790
// 提出ID : 10498790
// 問題ID : abc151_f
// コンテストID : abc151
// ユーザID : xryuseix
