/*
問題文の引用元：https://atcoder.jp/contests/abc153/tasks/abc153_d
D - Caracal vs Monster
Time Limit : 2 sec / Memory Limit : 1024 MB
配点 : 400 点
問題文 : カラカルはモンスターと戦っています。モンスターの体力は H
です。カラカルはモンスターを 1
体選んで攻撃することができます。モンスターを攻撃したとき、攻撃対象のモンスターの体力に応じて、次のどちらかが起こります。モンスターの体力が
1 なら、そのモンスターの体力は 0 になるモンスターの体力が X >1
なら、そのモンスターは消滅し、体力が \lfloor X/2 \rfloor のモンスターが新たに 2
体現れる（\lfloor r \rfloor は r
を超えない最大の整数を表す）全てのモンスターの体力を 0
以下にすればカラカルの勝ちです。カラカルがモンスターに勝つまでに行う攻撃の回数の最小値を求めてください。
制約1 \leq H \leq
10^{12}入力中のすべての値は整数である。入力入力は以下の形式で標準入力から与えられる。H出力カラカルがモンスターに勝つまでに行う攻撃の回数の最小値を出力せよ。
