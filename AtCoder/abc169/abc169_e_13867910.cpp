...
配点 : 500 点
問題文 : N 個の整数 X_1, X_2, \cdots, X_N があり、A_i \leq X_i \leq B_i
であることがわかっています。X_1, X_2, \cdots, X_N
の中央値として考えられる値はいくつあるか求めてください。注記X_1, X_2, \cdots,
X_N の中央値は次のように定義されます。X_1, X_2, \cdots, X_N
を昇順に並び替えたものを x_1, x_2, \cdots, x_N とします。N
が奇数のとき、中央値は x_{(N+1)/2}N が偶数のとき、中央値は (x_{N/2} + x_{N/2+1})
/ 2
制約2 \leq N \leq 2 \times 10^51 \leq A_i \leq B_i \leq
