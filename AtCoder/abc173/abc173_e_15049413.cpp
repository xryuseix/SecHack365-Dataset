/*
問題文の引用元：https://atcoder.jp/contests/abc173/tasks/abc173_e
E - Multiplication 4
Time Limit : 2 sec / Memory Limit : 1024 MB
配点 : 500 点
問題文 : N 個の整数 A_1,\ldots,A_N が与えられます。このなかからちょうど K
個の要素を選ぶとき、選んだ要素の積としてありえる最大値を求めてください。そして、答えを
(10^9+7) で割った余りを 0 以上 10^9+6 以下の整数として出力してください。
制約1 \leq K \leq N \leq 2\times 10^5|A_i| \leq
10^9入力入力は以下の形式で標準入力から与えられる。N KA_1 \ldots A_N出力答えを
(10^9+7) で割った余りを、0 以上 10^9+6 以下の整数として出力せよ。
