/*
問題文の引用元：https://atcoder.jp/contests/abc179/tasks/abc179_d
D - Leaping TakEditorial
Time Limit : 2 sec / Memory Limit : 1024 MB
配点 : 400 点
問題文 : 一列に並んだ N マスから成るマス目があり、マスには左から順番に1, 2,
\ldots, N の番号がついています。このマス目で暮らしている高橋君は、現在マス 1
にいて、後述の方法で移動を繰り返してマス N へ行こうとしています。10 以下の整数 K
と、共通部分を持たない K 個の区間 [L_1, R_1], [L_2, R_2], \ldots, [L_K, R_K]
が与えられ、これらの区間の和集合を S とします。ただし、区間 [l, r] は l 以上 r
以下の整数の集合を表します。マス i にいるとき、S から整数を 1 つ選んで (d
とする)、マス i + d
に移動する。ただし、マス目の外に出るような移動を行ってはならない。高橋君のために、マス
N に行く方法の個数を 998244353 で割った余りを求めてください。
制約2 \leq N \leq 2 \times 10^51 \leq K \leq \min(N, 10)1 \leq L_i \leq R_i \leq
N[L_i, R_i] と [L_j, R_j] は共通部分を持たない (i \neq j)
入力はすべて整数である入力入力は以下の形式で標準入力から与えられる。N KL_1
R_1L_2 R_2:L_K R_K出力高橋くんがマス 1 からマス N に行く方法の個数を 998244353
で割った余りを出力せよ。
