/*
問題文の引用元：https://atcoder.jp/contests/agc039/tasks/agc039_a
A - Connection and DisconnectionEditorial
Time Limit : 2 sec / Memory Limit : 1024 MB
配点 : 300 点
問題文 : 文字列 S が与えられます。S を K 回繰り返してできる文字列を T
とします。T の文字をひとつ選んで他の文字に書き換える操作を繰り返すことで T
のどの隣り合う 2
文字も相異なるようにするとき、必要な操作の回数の最小値を求めてください。
制約1 \leq |S| \leq 100S は英小文字からなる1 \leq K \leq 10^9K
は整数である入力入力は以下の形式で標準入力から与えられる。SK出力必要な操作の回数の最小値を出力せよ。
