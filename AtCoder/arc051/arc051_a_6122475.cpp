...
問題文 : 白く塗られた二次元平面を考えます。まず、(x_1, y_1) からの距離が r
以下の部分を赤く塗ります。そのあと、 x_2 ≦ x ≦ x_3, y_2 ≦ y ≦ y_3 を満たす (x,
y)
を青く塗ります。なお、赤く塗られた後、更に青く塗られた部分は紫色になるとします。赤く塗られた部分と青く塗られた部分が存在するかどうかをそれぞれ判定してください。
制約-100 ≦ x_1, y_1 ≦ 100-100 ≦ x_2 < x_3 ≦ 100-100 ≦ y_2 < y_3 ≦ 1001 ≦ r ≦
100与えられる数は全て整数である。入力入力は以下の形式で標準入力から与えられる。x_1
y_1 rx_2 y_2 x_3 y_3出力2 行出力せよ。1 行目には赤く塗られた部分が存在するならば
YES、そうでないなら NO を出力。2 行目には青く塗られた部分が存在するならば
YES、そうでないなら NO を出力する。
